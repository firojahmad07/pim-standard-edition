...
import {Button, getColor, SectionTitle, useBooleanState} from '@akeneo-pim-community/akeneo-design-system';
...
const UnitDetails = ({
  ...
  }, [closeConfirmDeleteUnitModal, measurementFamily, selectedUnitCode, onMeasurementFamilyChange, selectUnitCode]);
