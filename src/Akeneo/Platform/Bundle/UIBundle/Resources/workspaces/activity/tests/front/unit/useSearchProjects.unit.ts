...
import {useSearchProjects} from '@akeneo-pim-community/activity/src/hooks';
import {Project} from '@akeneo-pim-community/activity/src/domain';
import {act} from 'react-test-renderer';
import {fetchProjects} from '@akeneo-pim-community/activity/src/fetchers';
import {aProject, buildProjects} from './utils/provideTwaProjectsHelper';

jest.mock('@akeneo-pim-community/activity/src/fetchers/fetchProjects');
