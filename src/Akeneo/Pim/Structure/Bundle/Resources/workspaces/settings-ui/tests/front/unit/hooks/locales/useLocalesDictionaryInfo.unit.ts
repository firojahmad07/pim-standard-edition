...
import {useLocalesDictionaryInfo} from '@akeneo-pim-community/settings-ui';
import {fetchLocalesDictionaryInfo} from '@akeneo-pim-community/settings-ui/src/infrastructure/fetchers/fetchLocalesDictionaryInfo';

const FeatureFlags = require('pim/feature-flags');
FeatureFlags.isEnabled.mockImplementation((feature: string) => false);

jest.mock('@akeneo-pim-community/settings-ui/src/infrastructure/fetchers/fetchLocalesDictionaryInfo');
