...
import {Collapse, Field, Helper, Pill, SelectInput} from '@akeneo-pim-community/akeneo-design-system';
...
const MeasurementConversion = ({
  ...
  return (
    <Collapse
      ...
      label={
        <>
          {translate('akeneo.tailored_export.column_details.sources.operation.measurement_conversion.title')}
          ...
          {null !== measurementFamily && (
            <SelectInput
              ...
              placeholder={translate(
                'akeneo.tailored_export.column_details.sources.operation.measurement_conversion.placeholder'
              )}
